...
>
> **กติกาเพื่อคนอ่าน (dev ต้องอ่านรู้เรื่อง ไม่ใช่แค่ AI):** (5) ทุก section เปิดด้วยร้อยแก้ว 1-3 ประโยคก่อนเข้าตาราง — บอกว่า section นี้ตอบคำถามอะไรและข้อสรุปคืออะไร (6) ตารางมีไว้ enumerate ข้อเท็จจริง ส่วนคำอธิบาย/นัยยะอยู่ในร้อยแก้วรอบตาราง ห้ามยัด logic ลง cell (7) ห้ามใช้ตัวย่อที่คิดขึ้นเอง — ศัพท์ domain ที่ทีมใช้ให้คงไว้แต่ต้องมีคำอธิบายครั้งแรกที่ปรากฏ (8) DNA.md ต้องเริ่มด้วย TL;DR ที่ dev อ่าน 5 นาทีแล้วเล่าต่อให้คนอื่นฟังได้
...
7. **เขียนให้ dev อ่านรู้เรื่อง ไม่ใช่แค่ AI** — ทำตาม "กติกาเพื่อคนอ่าน" ใน template (ทุก section เปิดด้วยร้อยแก้วสรุป, ตารางมีคำอธิบายรอบ, ห้ามตัวย่อที่คิดเอง) และปิดงานด้วยการเขียน TL;DR ที่ dev ใหม่อ่าน 5 นาทีแล้วเล่าต่อได้
...
## TL;DR — อ่าน 5 นาที (เขียนเป็นภาษาคน สำหรับ dev ที่เพิ่งเข้าทีม)

เขียน**หลังสุด**เมื่อทุก section เสร็จแล้ว — ร้อยแก้วล้วน ห้ามมีตาราง ตอบ 5 คำถามนี้ตามลำดับ:

1. ระบบนี้ทำอะไร ให้ใคร และถ้าพังใครเดือดร้อน (2-3 ประโยค)
2. หัวใจของระบบคืออะไร — capability ไหนคือเหตุผลที่ระบบนี้มีอยู่ (2-3 ประโยค)
3. อะไรห้ามพังเด็ดขาดตอน rewrite และทำไม (2-3 ประโยค)
4. ของอันตรายที่สุดที่เจอตอนแกะคืออะไร (2-3 ประโยค)
5. ก่อนเริ่ม rewrite ต้องรอคำตอบเรื่องอะไรจากใคร (1-2 ประโยค)

> เกณฑ์ผ่าน: dev ที่ไม่เคยเห็นระบบอ่านจบแล้ว**เล่าต่อให้เพื่อนฟังได้ถูกต้อง**โดยไม่ต้องเปิด section อื่น
